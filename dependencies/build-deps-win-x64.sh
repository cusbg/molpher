...
build_boost() {
    ...
    ./b2 toolset=gcc variant=release link=static runtime-link=shared threading=multi -a -q --with-date_time --with-filesystem --with-graph --with-log --with-program_options --with-regex --with-serialization --with-signals --with-thread
